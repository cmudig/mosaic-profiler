...
var import_npmlog9, import_os3, import_path6, import_write_file_atomic;
...
var import_clone_deep, import_dedent3, import_npmlog12, import_client, import_os4, DEFAULT_CONCURRENCY, Command;
var init_command = __esm({
  "libs/core/src/lib/command/index.ts"() {
    ...
    DEFAULT_CONCURRENCY = import_os4.default.cpus().length;
...
var require_defaults = __commonJS({
  "libs/core/src/lib/npm-conf/defaults.ts"(exports2) {
    ...
    var import_path27 = __toESM(require("path"));
    var temp = import_os8.default.tmpdir();
    ...
    var home = import_os8.default.homedir();
    if (home) {
    ...
    Object.defineProperty(exports2, "defaults", {
      get() {
        ...
        defaults = {
          ...
          usage: false,
          user: process.platform === "win32" || import_os8.default.type() === "OS400" ? 0 : "nobody",
...
function packDirectory(_pkg, dir, options) {
  ...
  let chain = Promise.resolve(void 0);
...
function writeLogFile2(cwd) {
  ...
  import_npmlog40.default.record.forEach((m) => {
    ...
    pref = pref.join(" ");
    m.message.trim().split(/\r?\n/).map((line) => `${pref} ${line}`.trim()).forEach((line) => {
      logOutput += line + import_os5.default.EOL;
    });
  });
...
var import_npmlog40, import_os5, import_path20, import_write_file_atomic2;
...
var import_clone_deep2, import_dedent5, import_execa3, import_npmlog43, import_os6, DEFAULT_CONCURRENCY2, Command2;
var init_command2 = __esm({
  "libs/legacy-core/src/lib/command/index.ts"() {
    ...
    DEFAULT_CONCURRENCY2 = import_os6.default.cpus().length;
    Command2 = class {
...
var import_devkit5, import_fs6, import_fs_extra13, import_npmlog50, import_tree, LARGE_BUFFER, childProcess16, PACKAGE_GLOB, InitCommand;
var init_src9 = __esm({
  "libs/commands/init/src/index.ts"() {
    "use strict";
    init_src2();
...
var import_npmlog51, childProcess17;
...
var import_devkit6, import_fs7, import_npmlog52, import_path22, import_slash3, childProcess18, resolvedPrettier;
...
function gitCommit(message, { amend, commitHooks, signGitCommit, signoffGitCommit }, opts) {
  ...
  } else if (message.indexOf(import_os7.EOL) > -1) {
...
var import_npmlog53, import_os7, childProcess19;
...
var import_npmlog58, childProcess24;
    ...
    var VersionCommand = class extends Command {
      ...
      confirmVersions() {
        if (this.options.json) {
          ...
          output("");
          output("Changes:");
          output(changes.join(import_os8.default.EOL));
          output("");
        }
        if (this.options.yes) {
      ...
      async gitCommitAndTagVersionForUpdates() {
        ...
        const message = tags.reduce((msg, tag) => `${msg}${import_os8.default.EOL} - ${tag}`, `${subject}${import_os8.default.EOL}`);
...
var import_npmlog60, childProcess25;
...
var import_npm_package_arg8, import_npmlog61, childProcess26;
...
var import_npmlog63, childProcess27;
    ...
    var PublishCommand = class extends Command {
      ...
      async execute() {
        ...
        if (this.options.summaryFile !== void 0) {
          ...
          output(message.join(import_os8.default.EOL));
        }
